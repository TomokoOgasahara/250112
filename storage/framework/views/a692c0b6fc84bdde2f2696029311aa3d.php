...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('/recruit_touroku.css')); ?>">
...
<body>
    ...
    <form action="<?php echo e(url('/recruit_touroku')); ?>" method="POST" enctype="multipart/form-data">
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/gs-laravel/resources/views/recruit_touroku.blade.php ENDPATH**/ ?>