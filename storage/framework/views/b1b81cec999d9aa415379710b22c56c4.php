...
<form method="POST" action="<?php echo e(route('review_touroku.store')); ?>">
    <?php echo csrf_field(); ?> <!-- Laravelで必要なCSRFトークン -->
        <div  class="form1">
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/gs-laravel/resources/views/review_touroku.blade.php ENDPATH**/ ?>