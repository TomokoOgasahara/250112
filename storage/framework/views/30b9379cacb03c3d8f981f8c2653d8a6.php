...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('/comps_database.css')); ?>?v=2">
...
<div class="title">
    <div class="title1"><a href="<?php echo e(asset('/top')); ?>">STEM GATE</a></div>
...
<!-- 選択された企業のデータ表示 -->
    ...
    <div class="bd2">
        ...
        <span class="value"><?php echo e($selectedCompany->comp_name); ?></span>
    </div>
    <div class="bd2">
        <span class="label">平均年齢:</span>
        <span class="value"><?php echo e($selectedCompany->av_age); ?>[歳]</span>
    </div>
    <div class="bd2">
        <span class="label">平均給与:</span>
        <span class="value"><?php echo e($selectedCompany->av_salary); ?>[万円]</span>
    </div>
    <div class="bd2">
        <span class="label">売上:</span>
        <span class="value"><?php echo e($selectedCompany->sales); ?>[100万円]</span>
    </div>
    <div class="bd2">
        <span class="label">営業利益率:</span>
        <span class="value"><?php echo e($selectedCompany->profit); ?>[%]</span>
    </div>
    <div class="bd2">
        <span class="label">純利益率:</span>
        <span class="value"><?php echo e($selectedCompany->net_profit); ?>[%]</span>
    </div>
    <?php else: ?>
...
<div class="button2-container">
    <a href="<?php echo e(asset('/review')); ?>" class="button2">口コミ詳細はこちら</a>
</div>
...
<div class="wd-box">
    ...
    <span class="wdvalue"><?php echo e($rankingData['turnover_rate_rank'] ?? 'データ無し'); ?></span>
    <div class="rank">位/27企業</div>
</div>
<div class="wd-box">
    <span class="wdlabel">平均勤続年数の差異ランキング:</span>
    <span class="wdvalue"><?php echo e($rankingData['avg_tenure_rank'] ?? 'データ無し'); ?></span>
    <div class="rank">位/27企業</div>
    </div>
<div class="wd-box">
    <span class="wdlabel">男女の賃金差ランキング:</span>
    <span class="wdvalue"><?php echo e($rankingData['wage_gap_rank'] ?? 'データ無し'); ?></span>
    <div class="rank">位/27企業</div>
</div>
</div>
...
<div class="wd-box2">
    ...
    <span class="wdvalue"><?php echo e($sonotaData['avg_overtime_hours'] ?? 'データ無し'); ?></span>
    <div class="rank">時間</div>
</div>
<div class="wd-box2">
    <span class="wdlabel">有給休暇取得率（％）</span>
    <span class="wdvalue"><?php echo e($sonotaData['paid_leave_usage_rate'] ?? 'データ無し'); ?></span>
    <div class="rank">％</div>
    </div>
</div>
...
<div class="ai-box-good">
    ...
    <span class="aicomment"><?php echo e($aiData['good_point'] ?? 'データ無し'); ?></span>
</div>
  <!-- 悪いところセクション -->
<div class="ai-box-bad">
    <span class="ai-box1">悪いところ</span>
    <span class="aicomment"><?php echo e($aiData['bad_point'] ?? 'データ無し'); ?></span>
</div>
</div>
...
<div class="linkinfo">
    <div class="button3"><a href="<?php echo e(asset('/event')); ?>">イベント情報はこちら</a></div>
    <div class="button3"><a href="<?php echo e(asset('/recruit')); ?>" >求人情報はこちら</a></div>
</div>
...
<script>
    // データ取得
    const reviewData = <?php echo json_encode($averageScores ?? [], 15, 512) ?>;
    const genderData = <?php echo json_encode($womensDataArray ?? [], 15, 512) ?>;
    const tenureData = <?php echo json_encode($tenureDataArray ?? [], 15, 512) ?>;
    const wageGapData = <?php echo json_encode($wageGapDataArray ?? [], 15, 512) ?>;
