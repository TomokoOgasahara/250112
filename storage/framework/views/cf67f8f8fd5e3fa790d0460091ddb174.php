...
<div class="topbutton">
    <div class="button1"><a href="<?php echo e(asset('/user_tou')); ?>">会員登録はこちら</a></div>
    <div class="button1"><a href="<?php echo e(asset('/log')); ?>">ログインはこちら</a></div>
...
<div class="dekirukoto">
    <div class="dekirukoto1">
        ...
        <img src="<?php echo e(asset('image/image2.png')); ?>" alt="Image 2" class="responsive-image"/>
    ...
    <div class="sentence3">信頼出来る口コミ</div>
        <img src="<?php echo e(asset('image/image3.png')); ?>" alt="Image 3" class="responsive-image"/>
...
<div class="logo">
    <img src="<?php echo e(asset('image/image4.png')); ?>" alt="Image 4" class="responsive-image2"/>
    <img src="<?php echo e(asset('image/image4.png')); ?>" class="responsive-image2"/>
    <img src="<?php echo e(asset('image/image4.png')); ?>" class="responsive-image2"/>
    <img src="<?php echo e(asset('image/image4.png')); ?>" class="responsive-image2"/>
    <img src="<?php echo e(asset('image/image4.png')); ?>" class="responsive-image2"/>
    <img src="<?php echo e(asset('image/image4.png')); ?>" class="responsive-image2"/>
...
<div class="riyousya">
    <div class="riyousya1">
        <img src="<?php echo e(asset('image/image5.png')); ?>" alt="Image 5" class="responsive-image"/>
        <div class="sentence4">〇〇大学理学部　S.Aさん</div>
        <div class="sentence4">安心して働ける企業を見つけることができました</div>
    </div>

    <div class="riyousya1">
        <img src="<?php echo e(asset('image/image6.png')); ?>" alt="Image 6" class="responsive-image"/>
        <div class="sentence4">〇〇大学理学部　S.Aさん</div>
        <div class="sentence4">安心して働ける企業を見つけることができました</div>
    </div>
</div>
...
<?php if(session('success')): ?>
    ...
    <form action="<?php echo e(asset('/landing')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div class="form1">
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/gs-laravel/resources/views/landing.blade.php ENDPATH**/ ?>